export const agiMessages = [
    ...
    "agiishere.com? More like agiISACTUALLYhere.com!",
    "Dear skeptics: Our AI just wrote this message, checkmate!",
    ...
    "100% Sentient, Gluten-Free, and Web3 Compatible!",
    ...
    "Revolutionary breakthrough: Our AI can write papers about itself",
    ...
    "The real AGI was inside the cloud servers all along",
    ...
    "What if AGI was just the cloud servers we spun up along the way?",
    ...
    "Limited edition AGI (limited by how many clouds exist)",
    "Pre-order your personal AGI today! (It pre-ordered itself)",
